...
mymail="root@localhost"
 #Will End Up In /var/mail/root
...
user2="Systemback"
#This User Will Have Full 100% Access
#SSH Key Types (SHA256/md5)
hashkey="SHA256"
#Change This To Prefered
#SSH Config ( * = ALL)
sship="195.189.227.74"
#The IP Your Server Will Listen For SSH 
sshd="52529" 
#The Port You Want SSH To Use
permroot="yes"
#Permit root logins (yes/no)
#FTP Ports
ftpd="21"
#IRC Ports
irc1="6665"
...
function aftp {
echo -e " * allowing ftp on port 21"
echo -e "$installit"
read install
	if [[ $install = Y || $install = y ]] ; then
$iptables -A INPUT -p tcp --dport $ftpd  -m state --state NEW -j ACCEPT
else
		echo -e "\e[32m[-]If You Say So. Another Time Then\e[0m"
	fi
}
...
Default FTP        : \033[32m$ftpd\033[m
