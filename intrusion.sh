...
###############################################
#  ____________________________ __________ ._.#
...
if [ $UID -ne 0 ]; then
    echo -e "\033[34mThis Program Must Be Run As Root Or This Will FAIL.\033[m"
    sleep 3
    fi
...
if [[ "$silent" = "1" ]];then
	...
	last_version=$(curl --silent -q https://raw.githubusercontent.com/JeSTeRFLA/IntrusionScript/master/version) ### Store Last Version To Variable
	if [[ $last_version > $version ]];then ### Comparing To Current
...
### End IPTables Funtion

### Start System Hardening Menu
function syshard {
clear
echo -e "
\033[34m################################################################\033[m
...
### End System Hardening Menu
### Start Hardening Function
function gsshkey {
